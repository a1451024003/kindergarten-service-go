...
type UserService struct {
	...
	Create      func(phone string, name string, avater string, password string, kindergartenId int, role int, Image string) (int, error)
}
...
func (o *OrganizationalController) GetOrganization() {
	...
	if valid.HasErrors() {
		...
		v, err := models.GetTeacherOrganization(kindergarten_id, page, prepage)
		if err != nil {
...
// GetOrganization ...
// @Title 教师组织架构列表
// @Description 教师组织架构列表
// @Param	kindergarten_id           query	int	     true		"幼儿园ID"
// @Param	page                      query	int	     false		"页数"
// @Param	per_page                  query	int	     false		"每页显示条数"
// @Success 200 {object} models.Organizational
// @Failure 403
// @router /organ_teacher [get]
func (o *OrganizationalController) GetTeacherOrganization() {
	prepage, _ := o.GetInt("per_page", 20)
	page, _ := o.GetInt("page")
	kindergarten_id, _ := o.GetInt("kindergarten_id")
	valid := validation.Validation{}
	...
	if valid.HasErrors() {
		...
		v, err := models.GetWebOrganization(kindergarten_id, page, prepage)
		if err != nil {
			o.Data["json"] = JSONStruct{"error", 1005, nil, "获取组织架构失败"}
		} else {
			o.Data["json"] = JSONStruct{"success", 0, v, "获取组织架构成功"}
...
func (o *OrganizationalController) GetKC() {
	...
	if valid.HasErrors() {
		...
		v, err := models.GetkinderClass(kindergarten_id, user_id, class_type)
		if err != nil {
			o.Data["json"] = JSONStruct{"error", 1005, nil, err.Error()}
		} else {
			o.Data["json"] = JSONStruct{"success", 0, v, "获取成功"}
...
func (o *OrganizationalController) FilterStudent() {
	class_id, _ := o.GetInt("class_id")
	class_type, _ := o.GetInt("class_type")
	student_type, _ := o.GetInt("student_type")
	kindergarten_id, _ := o.GetInt("kindergarten_id")
	v, err := models.FilterStudent(class_id, class_type, kindergarten_id, student_type)
	if err != nil {
		o.Data["json"] = JSONStruct{"error", 1005, nil, "获取失败"}
	} else {
		o.Data["json"] = JSONStruct{"success", 0, v, "获取成功"}
