...
func (o *OrganizationalController) GetClass() {
	...
	v, err := models.GetAdminClassAll(kindergarten_id, class_type, page, prepage)
	if err != nil {
...
// AddManyClass ...
// @Title 创建多个班级班级
// @Description 创建多个班级班级
// @Param	kindergarten_id      query	int	     true		"幼儿园id"
// @Param	class_type           query	int	     true		"班级类型"
// @Success 200 {object} models.Organizational
// @Failure 403
// @router /many_class [post]
func (o *OrganizationalController) AddManyClass() {
	class := o.GetString("class")
	kindergarten_id, _ := o.GetInt("kindergarten_id")
	err := models.Store_Class(kindergarten_id, class)
	if err != nil {
		o.Data["json"] = JSONStruct{"error", 1003, nil, err.Error()}
	} else {
		o.Data["json"] = JSONStruct{"success", 0, nil, "保存成功"}
	}
	o.ServeJSON()
}
...
// @Success 200 {object} models.Organizational
// @Failure 403
// @router /auth_class [get]
func (o *OrganizationalController) AuthClass() {
	kindergarten_id, _ := o.GetInt("kindergarten_id")
	v := models.AuthClass(kindergarten_id)
	o.Data["json"] = JSONStruct{"success", 0, v, "获取成功"}
	o.ServeJSON()
}
...
// GetKCAll ...
// @Title 班级的幼师，幼儿人数
// @Description 班级的幼师，幼儿人数
// @Param	user_id                   query	int	     true		"用户id"
// @Param	kindergarten_id           query	int	     true		"幼儿园id"
// @Success 200 {object} models.Organizational
// @Failure 403
// @router /class_kinder [get]
func (o *OrganizationalController) GetKCAll() {
	class_type, _ := o.GetInt("class_type")
	kindergarten_id, _ := o.GetInt("kindergarten_id")
	valid := validation.Validation{}
	valid.Required(kindergarten_id, "kindergarten_id").Message("幼儿园id不能为空")
	if valid.HasErrors() {
		...
		v, err := models.GetkinderAll(kindergarten_id, class_type)
		if err != nil {
			o.Data["json"] = JSONStruct{"error", 1005, nil, err.Error()}
		} else {
			o.Data["json"] = JSONStruct{"success", 0, v, "获取成功"}
