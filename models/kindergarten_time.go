...
//时间安排
func GetKindergartenTimeInfo(class_type int, class_id int, kindergarten_id int) map[string]interface{} {
	...
	if class_id > 0 {
		...
		where += " and type = 0 and class_type =" + strconv.Itoa(class_type) + " and kindergarten_id=" + strconv.Itoa(kindergarten_id)
	}
...
删除
*/
func DeleteKGtime(id int) (err error) {
	o := orm.NewOrm()
	v := KindergartenTime{Id: id}
	if err = o.Read(&v); err == nil {
		if _, err = o.Delete(&KindergartenTime{Id: id}); err == nil {
			return nil
		}
	}
	return err
